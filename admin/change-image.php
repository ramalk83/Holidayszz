...
header('location:index.php');
    ...
    if(isset($_POST['submit']))    {
        $pimage=$_FILES["packageimage"]["image"];
        move_uploaded_file($_FILES["packageimage"]["tmp_image"],.$_FILES["packageimage"]["name"]);
...
<ol class="breadcrumb">
    ...
    <form class="horizontal-form" name= "package" method="post"  enctype="multipart/form-data">
    <?php 
    $imgid=intval($_GET['imgid']);
